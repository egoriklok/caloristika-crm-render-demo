  ...
  return {
    ...
    tools: [
      ...
      },
      {
        ...
        output_note: "Batch refreshes CRM company enrichment with dry_run, limit, cache_ttl_hours, source_statuses, cache_hit and saved flags.",
        input_schema: {
          type: "object",
          properties: {
      ...
      },
      {
        ...
        output_note: "Server-side 2GIS Places API lead search. Defaults to dry_run and returns candidates plus suggested /api/companies payloads; confirmed import uses lead-intake.",
        input_schema: {
          type: "object",
          properties: {
            query: { type: "string" },
